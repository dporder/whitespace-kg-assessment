...
AUDIT_BATCH_SIZE = 10               # audit items per checker call: one unparseable
AUDIT_TOKENS_PER_ITEM = 120         # reply costs its own batch, not the whole audit
AUDIT_TOKEN_OVERHEAD = 400          # llm.py defaults to 1024, too few for 40 verdicts
